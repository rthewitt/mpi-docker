(function() {
  ...
  define(function(require, exports, module) {
    ...
    var markup = require('text!ext/myelin/gpanel.xml');
    var logger = require("ext/console/logger");
    var Noderunner = require('ext/noderunner/noderunner');
    var css = require("text!ext/myelin/mpi-console.css");
    var codeTour = require('ext/myelin/codetour');
    var videoZen = require('ext/myelin/zen');
    var menus = require("ext/menus/menus");
    var ideConsole = require("ext/console/console");
    var commands = require("ext/commands/commands");
    var tabBehaviors = require('ext/tabbehaviors/tabbehaviors');
    var tabSessions = require('ext/tabsessions/tabsessions');

    var dom = require("ace/lib/dom");
    var event = require("ace/lib/event");
    var Range = require("ace/range").Range
    
    // Remember to add deps
    return module.exports = ext.register('ext/myelin/gpanel', {
      ...
      getStudentFromGlial: function() {
           var _self = this;
           this.sendAjaxRequest({
            url: 'http://'+window.location.hostname+':8080/glial/manage/session',
            params: 'return=student-info',
            method: 'GET',
            success: function(data){
                var student = JSON.parse(data).student;
                var course = JSON.parse(data).course;
                window.studentId = student;
                window.courseUUID = course;
                setTimeout(_self.lessonMedia(), 1000);
                }            
            }); 
      },
	...
	// This may be the original show flag for studentBuild, in which case I say hide it.
        ...
        updateHandler: function() {
            var _self = this;
            this.ajaxActionHandler('action=update');
